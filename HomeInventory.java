...
public class HomeInventory extends JFrame {
	...
	public HomeInventory() {
		...
		//Adding Controls and separators in tool bar
		...
		inventoryToolBar.addSeparator();   //Added Separator
		...
		itemLabel.setText("Inventory Label");
		gridConstraints=new GridBagConstraints();
	...
	private void searchButtonActionPerformed(ActionEvent e) {
		...
		JOptionPane.showConfirmDialog(null, "No "+letterClicked.toUpperCase()+" inventory items.", "None Found",JOptionPane.DEFAULT_OPTION,JOptionPane.INFORMATION_MESSAGE);
	...
	private void saveButtonActionPerformed(ActionEvent e) {
		...
		if(itemTextField.getText().equals("")) {
			JOptionPane.showConfirmDialog(null, "Must Have Item Discription.","Error",JOptionPane.DEFAULT_OPTION,JOptionPane.ERROR_MESSAGE);
	...
	public int print(Graphics g,PageFormat pf,int pageIndex) {
		...
		for(i=0+HomeInventory.entriesPerPage*pageIndex;i<iEnd;i++) {
			...
			if(HomeInventory.myInventory[i].marked)
				...
				g2D.drawString("Item is NOT mraked with identifying information.", (int)(pf.getImageableX()+25), y);
			y+=dy;
